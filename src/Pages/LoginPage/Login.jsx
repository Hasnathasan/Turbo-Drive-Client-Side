        ...
        <div className="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <button
                type="button"
                className="text-white bg-primary2 hover:bg-primary1/90 focus:ring-4 focus:outline-none focus:ring-primary2/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2"
              >
                <svg
                  className="w-4 h-4 mr-2 -ml-1"
                  aria-hidden="true"
