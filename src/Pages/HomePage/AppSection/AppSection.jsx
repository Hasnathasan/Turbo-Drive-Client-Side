...
const AppSection = () => {
  return (
    <div className="my-36 px-5 md:px-0 grid grid-cols-1 md:grid-cols-2 items-center gap-4">
      <div className="mockup-phone w-[290px] sm:w-[350px] md:w-[380px]">
        <div className="camera"></div>
        <div className="display">
          <img className="w-full" src={appBanner} alt="" />
        </div>
      </div>
      <div>
