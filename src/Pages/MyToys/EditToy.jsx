...
const EditToy = () => {
  ...
  return (
    <div className="w-full bg-white rounded-lg shadow mx-auto  md:mt-0 sm:max-w-md p-10">
      ...
      >
        <div>
          <h2 className="text-base md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r to-[#da8deb] from-[#47dcd1]">
            Edit: {productName}
          </h2>
          <label
            htmlFor="price"
        ...
        <div>
          ...
          <textarea
            ...
            name="description"
            rows="8"
            className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary2 focus:border-primary2"
            required
